...
- **Smart selection** – The extension expands your selection to valid Python statements or blocks.
- **Visual line markers** – Line markers shows the smart selection and execution state:
